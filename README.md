...
```
git clone https://github.com/TheStoneMX/OpenStreetMap-Route-Planning --recurse-submodules
```
...
```
./OSM_A_star_search (build code is not included)
```
...
```
./test (build code is not included)
```

The code was tested on the following specifications

- **CPU:** `Intel(R) Core(TM) i9-8950HK CPU @ 4.8 Ghz`
- **GPU:** `Nvidia TITAN RTX 24 Gig`
- **OS:** ` Linux Mind 20.1 64 Bit`
